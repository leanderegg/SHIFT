...
#RT <- read.csv("Data_05042022/sapflow/20220331-101209 Log Download_ED04.csv", header=T, na.strings = "-1004600",skip = 3)
RT <- read.csv("Data_05042022/sapflow/20220530-111350 Log Download_ED04.csv", header=T, na.strings = "-1004600",skip = 3)
RT <- RT[-1,]
