...
lwa_new_df1 <- lwa_raw %>% 
  ...
  mutate(area_cm2 = case_when(
    species %in% c("blue oak") ~ dry_scan_area*1.166899, 
    species %in% c("live oak") ~ dry_scan_area*1.126367, 
    TRUE ~ as.numeric(dry_scan_area)
...
write.csv(wc_lwa_df, here::here("processed-data", "lwa_toenter_20240422.csv"))
