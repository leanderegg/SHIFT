...
ggsave(here("figures", "pv_slope_lwa_plot"), pv_slope, device = "jpg", width = 2, height = 3, dpi = 300)
```
...
ggsave(here("figures", "combined_plots_all_lwa"), combined_plots_all, device = "jpg", width = 10, height = 9, dpi = 300)
```
