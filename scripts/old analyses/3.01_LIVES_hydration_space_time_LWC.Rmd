...
```{r, echo=F}
wc_all_raw <- read_csv(here("processed-data", paste0("analysis_bothspp",datver,".csv")), show_col_types = FALSE) %>% 
...
ggsave(here("figures", "lma_long_quke_plot"), lma_plot, device = "jpg", width = 12, height = 2, dpi = 300)
...
ggsave(here("figures", "alas_long_quke_plot"), alas_plot, device = "jpg", width = 12, height = 2, dpi = 300)
```
