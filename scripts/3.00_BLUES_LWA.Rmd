...
df_33 <- data %>% 
 ...
 plotly::ggplotly(df_33 %>% ggplot(aes(y = water_potential, 
                             x = lwa_g_cm2_new, 
...
ggsave(here("figures", "qudo figures", "LWA", "lma_long_qudo_plot"), lma_plot, device = "jpg", width = 12, height = 2, dpi = 300)
...
ggsave(here("figures", "qudo figures", "LWA", "alas_long_qudo_plot"), alas_plot, device = "jpg", width = 12, height = 2, dpi = 300)
```
...
ggsave(here("figures", "qudo figures", "LWA", "nice_hydration_layered"), nice_hydration_layered, device = "jpg", width = 6, height = 4, dpi = 300)
```
...
ggsave(here("figures", "qudo figures", "LWA", "nice_hydration_slopes"), hyd_slopes, device = "jpg", width = 5, height = 2.5, dpi = 300)
```
...
ggsave(here("figures", "qudo figures", "LWA", "nice_hydration_ints"), hyd_ints, device = "jpg", width = 5, height = 2.5, dpi = 300)
```
...
ggsave(here("figures", "qudo figures", "LWA", "time_summary_slopes"), time_summary, device = "jpg", width = 2.5, height = 3, dpi = 300)
...
write_csv(lwa_g_cm2_new_mods, here::here("processed-data", "lwa_g_cm2_new_qudo_mods.csv"))
```
...
ggsave(here("figures", "qudo figures", "LWA", "pv_slope_plot_qudo"), pv_slope, device = "jpg", width = 1, height = 3, dpi = 300)
```
...
ggsave(here("figures", "qudo figures", "LWA", "combined_plots_all_qudo"), combined_plots_all, device = "jpg", width = 10, height = 9, dpi = 300)
```
