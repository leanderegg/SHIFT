...
write_csv(lwa_g_cm2_new_mods, here::here("processed-data", "model results", "lwa_quke_mods.csv"))
```
...
ggsave(here("figures", "quke figures", "LWC", "pv_slope_plot_quke"), pv_slope, device = "jpg", width = 1, height = 3, dpi = 300)
```
...
ggsave(here("figures", "quke figures", "LWA", "combined_plots_all_quke_new"), combined_plots_all, device = "jpg", width = 12, height = 8, dpi = 300)
```
