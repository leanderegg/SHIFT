...
time_season_mod <- lmer(water_potential ~ cwc + time_season + (1|week) + (cwc|tree)+ (1|site), data = wc_quke_md_df)

time_season_mod_df <- broom::tidy(time_season_mod)

#with separate periods: 
time_season_mod_int <- lmer(water_potential ~ cwc*time_season + (1|week) + (cwc|tree)+ (1|site), data = wc_quke_md_df)

time_season_mod_int_df <- broom::tidy(time_season_mod)

time_mod <- lmer(water_potential ~ cwc + (1|week) + (cwc|tree)+ (1|site), data = wc_quke_md_df)
#time_mod <- lmer(water_potential ~ cwc + (cwc|tree), data = wc_quke_md_df)
...
lin_time_mod <- lmer(water_potential ~ cwc + (1|week) + (cwc|tree) + (1|site), data = lin_wc_quke_md_df)
...
bef_time_mod <- lmer(water_potential ~ cwc + (1|week) + (cwc|tree) + (1|site), data = bef_wc_quke_md_df, REML = T)
