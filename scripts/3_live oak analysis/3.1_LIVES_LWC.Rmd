---
title: "Combined Analysis and Figures, quke LWC"
author: "Indra Boving"
date: "11/9022"
output:
...
#  filter(!week == 21) %>% #this week doesn't have very many samples,
  ...
  filter(!(week %in% c(14, 15, 33))) #these weeks only had 2 trees collected with both PD and MD live oaks; remove!
...
final_df_all %>% 
  write_csv(here::here("processed-data", "bootstrapped_df_quke_lwc_mean.csv"))
```
...
ggsave(here::here("figures", "quke figures", "LWC", "nice_hydration_slopes_bs_inds"), hyd_slopes_bs_inds, device = "jpg", width = 5, height = 2.5, dpi = 300)
```
...
ggsave(here::here("figures", "quke figures", "LWC", "nice_space"), space_nice, device = "jpg", width = 6, height = 4, dpi = 300)
```
...
ggsave(here::here("figures", "quke figures", "LWC", "nice_space_centered"), space_nice_centered, device = "jpg", width = 6, height = 4, dpi = 300)
```
...
ggsave(here::here("figures", "quke figures", "LWC", "nice_time"), time, device = "jpg", width = 4, height = 2, dpi = 300)
```
...
ggsave(here::here("figures", "quke figures", "LWC", "time_summary_slopes_boot_tree"), time_summary_bs_tree, device = "jpg", width = 2.5, height = 3, dpi = 300)
```
...
write_csv(lwc_mean_mods, here::here("processed-data", "lwc_mean_quke_mods.csv"))
```
...
ggplot2::ggsave(here::here("figures", "quke figures", "LWC", "combined_plots_all_quke"), combined_plots_all, device = "jpg", width = 10, height = 6, dpi = 300)
```
...
ggsave(here("figures", "quke figures", "lma_long_plot"), lma_swc_plot, device = "jpeg", width = 6, height = 1.75, dpi = 300)
```
#LMA by MPa, nice: 
...
ggsave(here::here("figures", "quke figures", "LWC", "lma_mpa_plot"), lma_mpa_plot, device = "jpg", width = 6, height = 4, dpi = 300)
```
