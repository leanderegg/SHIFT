...
```{r}
stacked_slopes_nice <- cowplot::plot_grid(space_slope, time_summary, 
                                   nrow = 3, 
                                   rel_heights = c(.9, .7),
                                   rel_widths = c(1, 1)) 
...
final_slopes<- cowplot::plot_grid(legend_scatterplots, stacked_slopes_nice, 
                                  nrow = 2, 
                                  rel_heights  = c(.25, 4))
#final_slopes

combined <- cowplot::plot_grid(stacked_nice, stacked_slopes_nice, 
                               ncol = 2, 
                               rel_widths = c(1, 1))
#combined

combined_legend <- cowplot::plot_grid(legend_scatterplots, combined, 
                                      nrow = 2, 
                                      rel_heights = c(.25, 4))
combined_legend
...
ggsave(here("figures", "combined_plots_all_cwc"), combined_plots_all, device = "jpg", width = 8, height = 5, dpi = 300)
```
