...
#for entering leaf scans in google sheets, sent to Rayna:
# wc_df_nona <-wc_df %>% 
...
```{r}
#This has the updated dry scans, from which we 
datver_lwa <- "20231128"
...
wc_df1 <- merge(wc_df, lwa_new_df, by = c("tree", "date_wc", "time", "week")) %>% 
...
write_csv(alas_df, here::here("processed-data", "alas_for_rayna.csv"))
