...
all_water_df_alas <- alas_all_water_df %>% 
  ...
  select(week, tree, time, plot, site, species, mpa_mean, lwc_mean, mean_swc_per_dry_g_y0, mean_swc_g_y0, lfm_y0_percent, lfm_y1_percent, lfm_both_percent, rwc_percent_y0, lwm_g, ldm_g, area_cm2, lma_g_cm2, alas_cm2_per_mm2, sla_cm_g, lwa_g_cm2) %>% 
  distinct() %>% 
  filter(tree > 1000)
```
