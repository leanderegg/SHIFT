...
#  filter(!week == 21) %>% #this week doesn't have very many samples,
  ...
  filter(!(week == 14)) #this week only had 2 trees collected with both PD and MD live oaks; remove!
...
ggsave(here::here("figures", "quke figures", "LWC", "combined_plots_all_quke"), combined_plots_all, device = "jpg", width = 12, height = 8, dpi = 300)
```
