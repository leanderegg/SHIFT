...
mvar <- lmer(water_potential ~ lwc + (1|site/tree) + (1|week), data=qudo_wc_all)

r.squaredGLMM(mvar) # plust the marginal R2 of lwc
var(qudo_wc_all$water_potential, na.rm=T) # 1.18
