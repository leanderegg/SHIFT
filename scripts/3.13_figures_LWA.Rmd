...
stacked_slopes_nice <- cowplot::plot_grid(space_slope, time_summary, 
                                   nrow = 3, rel_heights = c(.9, .7), rel_widths = c(1, 1)) 
...
x.grob2 <- textGrob("Leaf Water/Area (g)", 
                   gp=gpar(fontface="bold", #col="blue",
                           fontsize=15))
...
ggsave(here("figures", "combined_plots_all_lwa"), combined_plots_all, device = "jpg", width = 8, height = 5, dpi = 300)
```
