...
ggplot() +
    ...
    geom_point(aes(y = water_potential, x = lwc, shape = time), data = df_1, color = "#004f63") +
    geom_line(aes(y = water_potential, x = lwc, group = tree_week), color = "#004f63", data = df_1) +
    geom_point(aes(y = water_potential, x = lwc, shape = time), data = df_2, color = "#859b6c") +
    geom_line(aes(y = water_potential, x = lwc, group = tree_week), color = "#859b6c", data = df_2) +
    geom_point(aes(y = water_potential, x = lwc, shape = time), data = df_3, color = "goldenrod") +
    geom_line(aes(y = water_potential, x = lwc, group = tree_week), color = "goldenrod", data = df_3) +
    geom_point(aes(y = water_potential, x = lwc, shape = time), data = df_4, color = "#c969a1") +
    geom_line(aes(y = water_potential, x = lwc, group = tree_week), color = "#c969a1", data = df_4) +
    labs(y = "Water Potential (MPa)", 
       x = "Leaf Water Content (g)", 
       #caption = "triangles = predawn, circles = midday"
       ) +
...
weeks <- tibble(1:11)
weeks$week <- c(9, 10, 14, 15, 17, 18, 19, 21, 29, 33, 39) 
