...
```{r}
df_grey_groups <- wk_figs %>% 
  mutate(color = case_when(
    week %in% c('10', '11', '17', '19', '21', '29', '33', '33') ~ "grey", 
    week %in% c('10', '17', '29', '37') ~ "goldenrod", 
    TRUE ~ "grey"
  ))
...
df_grey_groups %>% 
  ggplot() +
  geom_point(aes(x=water_potential,y= lwc, group = tree, color=color)) + 
  geom_line(aes(x=water_potential,y= lwc, group = tree, color=color)) + 
  scale_color_identity(labels = c(blue = "a",gray = "Other"),guide = "legend")
```
