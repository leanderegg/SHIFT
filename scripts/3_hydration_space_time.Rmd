...
#+
  ...
  #              breaks = as.Date("2022-03-08","2022-03-15", "2022-03-25", "2022-03-23", "2022-03-30", "2022-04-04", "2022-04-06", "2022-04-13", "2022-04-11", "2022-04-27", "2022-04-25", "2022-05-04" ,"2022-05-09", "2022-05-25", "2022-05-23", "2022-07-19", "2022-08-18","2022-09-15"))
...
timeline_plot <- timeline_df %>% 
 # filter(time == "md") %>% 
  ...
  theme(legend.position = "none", 
        ...
        axis.text.y = element_blank(),
        axis.ticks = element_blank(), 
        axis.text.x = element_text(angle = 20, vjust = 0.5, hjust=.5)
        ) +
scale_x_date(date_labels = '%b. %d',
...
ggsave(here("figures", "timeline_plot"), timeline_plot, device = "jpg", width = 12, height = 1, dpi = 300)
```
