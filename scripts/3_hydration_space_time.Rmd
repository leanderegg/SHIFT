...
wc_qudo_df <- wc_all_raw %>% 
  ...
  select(week, time, lwc, water_potential, tree, tree_factor, plot, site, species, date_wc, date_wp) %>% 
  unique()
...
weeks <- data_frame(1:11)
weeks$week <- c(9, 10, 11, 12, 14, 15, 17, 18, 19, 21, 29) 
