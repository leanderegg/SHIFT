...
wk10_long_lwc <- wk10_wide %>% 
  ...
  pivot_longer(cols = c(lwc_pd, lwc_md), 
               names_to = "time", 
               values_to = "lwc") %>% 
  mutate(time = gsub(time, "lwc_", ""))

wk10_long_mpa <- wk10_wide %>% 
  drop_na(lwc_pd, lwc_md, water_potential_md, water_potential_pd) %>% 
  pivot_longer(cols = c(water_potential_pd, water_potential_md), 
                names_to = "time", 
                values_to = "water_potential") 

wk10_long <- bind_rows(wk10_long_lwc, wk10_long_mpa)
```
