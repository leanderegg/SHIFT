...
rwc_df <- rwc_all_raw %>% 
  ...
  select(week, time, lwc, water_potential, rwc_lwc_percent, rwc_lfm_percent, year, type, tree, tree_factor, plot, site, species, date_wp, mean_swc_per_dry_g, week_rwc_link) %>% 
  distinct() %>% 
  drop_na(type)
