...
ggplot(aes(y = Ks_nat, x = mean_md)) +
  ...
  ggtitle("Kstem over water potential space") +
  ylab("ks (g/mm2/sec/m/Mpa)")
...
ks_data_wp_sla %>% 
  ...
  geom_point() + 
  stat_summary(fun.y="mean", geom="line", aes(group=factor(tree))) +
  ggtitle("temporal changes in Y0:Y1")+
  ylab("New growth ratio") +
  xlab("Date")
```
