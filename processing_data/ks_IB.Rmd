...
These are mega high PLC values...vacuum infiltration maybe doesn't work as well as hoped? Or we did a bad job collecting? Not sure how to do it better that we did, though....
...
ks_data_wp %>% 
  filter(plc > 0) %>% 
ggplot(aes(y = k_g_mm_s_m_pa_max, x = mean_md*-1, color = tree)) +
  geom_point()+ 
